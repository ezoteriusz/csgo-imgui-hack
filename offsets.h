...
#include <cstdint>
		...
		#define dwForceAttack  0x31D3714
		#define dwForceAttack2  0x31D3720
		#define dwForceBackward  0x31D375C
		#define dwForceForward  0x31D3768
		#define dwForceJump  0x524CFDC
		#define dwForceLeft  0x31D3780
		#define dwForceRight  0x31D3774
		#define dwGameDir  0x627780
		#define dwGameRulesProxy  0x52C02CC
		#define dwGetAllClasses  0xDB202C
		#define dwGlobalVars  0x588CF0
		#define dwGlowObjectManager  0x52EB658
		#define dwInput  0x51F47B0
		#define dwInterfaceLinkList  0x945344
		#define dwLocalPlayer  0xD8A2DC
		#define dwMouseEnable  0xD8FE28
		#define dwMouseEnablePtr  0xD8FDF8
		#define dwPlayerResource  0x31D1AA0
		#define dwRadarBase  0x51D7F64
		#define dwSensitivity  0xD8FCC4
		#define dwSensitivityPtr  0xD8FC98
		#define dwSetClanTag  0x8A1B0
		#define dwViewMatrix  0x4D94B04
		#define dwWeaponTable  0x51F5270
		#define dwWeaponTableIndex  0x325C
		#define dwYawPtr  0xD8FA88
		#define dwZoomSensitivityRatioPtr  0xD94D28
		#define dwbSendPackets  0xD779A
		#define dwppDirect3DDevice9  0xA7050
		#define find_hud_element  0x2E75F720
		...
		#define m_pitchClassPtr  0x51D8200
		#define m_yawClassPtr  0xD8FA88
